...
3. Numerotarea este strict consecutiva de la 0001 la 1000.
4. Agentii pot lucra pe intervale diferite (ex: Agent A pe 0100-0200, Agent B pe 0500-0600), dar trebuie sa respecte dependentele de cod.
5. Daca un interval depinde de codul din alt interval care nu este inca gata, agentul va folosi interfete/mock-uri care vor fi implementate ulterior.
